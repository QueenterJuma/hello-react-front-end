 ...
 **hello-react-front-end** is app build using ruby on rails and react ([ruby on rails-repo](https://github.com/QueenterJuma/hello-rails-back-end))
...
```sh
  cd my-folder
  https://github.com/QueenterJuma/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/QueenterJuma/hello-react-front-end/issues).
